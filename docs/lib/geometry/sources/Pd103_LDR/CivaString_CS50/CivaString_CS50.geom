# seed name: Pd103- CivaString_CS50
# air kerma: 1.12495E-13
...
:start geometry definition:
    ...
    :start geometry:
        ...
        :start media input:
            media = CS10_Organpoly_Pd5% #  It supposed that each Pd region is filled with 5% natural pd and 95% organic polymer 
       	   :stop media input:
