...
#---------------------------------------------------------------------
				...
				:start geometry:
					...
					positions = 0.55038999 0.97084 1.6     
				:stop geometry:
				...
				:stop geometry:
					...
					:start geometry: 
						library = egs_cdgeometry
						name 	= first_plaque_x_out
						base geometry = first_cut_x
						set geometry = 0 eye_plaque_mold         
					:stop geometry: 
				
					:start geometry: 
						library = egs_cdgeometry
						name 	= first_plaque_xy_out
						base geometry = first_cut_y
						set geometry = 0 first_plaque_x_out         
					:stop geometry:
					...
					:start geometry: 
						library = egs_cdgeometry
						name 	= second_plaque_x_out
						base geometry = second_cut_x
						set geometry = 0 eye_plaque_mold         
					:stop geometry: 
				
					:start geometry: 
						library = egs_cdgeometry
						name 	= second_plaque_xy_out
						base geometry = second_cut_y
						set geometry = 0 second_plaque_x_out        
					:stop geometry:
					
			:start geometry:
				library = egs_gunion
				name 	= eye_plaque_boarders
				geometries = first_plaque_xy_out second_plaque_xy_out
			:stop geometry:
...
#---------------------------------------------------------------------
		...
		:start geometry:
			...
			geometries = plaque_chunk iris_hole eye_plaque_boarders eye_plaque_no_eye  	
		:stop geometry:
