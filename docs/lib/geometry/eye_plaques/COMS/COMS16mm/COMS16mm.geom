...
#       egs_brachy: a versatile and fast Monte Carlo code for
#       brachytherapy Phys Med Biol 61(2016) 8214 - 8231
#       
# and
...
:start geometry definition:
    ...
    :start geometry:
        ...
        library = egs_planes
        type = EGS_Zplanes
        positions = -1.505, -1.2419843, -1.21532917,  -0.9342912  # according to analytical calculation
		          # -1.505, -1.2420, -1.21533, -0.9342911752  # (Previous number)
    :stop geometry:
	...
	:start geometry:
        name = the_plaque
        library = egs_cdgeometry
        base geometry = cutoff_planes
        set geometry = 0 hollow_plaque
    :stop geometry:
