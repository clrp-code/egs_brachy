...
# geometry model are filled with air. To change the medium that
# fills the ends of the seed, change 'AIR_TG43_LD' in 'end_cylinder'
# and in 'base_end_sphere' to whatever medium desired.
#
#####################################################################
:start geometry definition:

    # change 'AIR_TG43_LD' to whatever medium the seed is inscribed
    # into
    :start geometry:
        name = end_cylinder
    ...
    # But do not change any of the media below
    :start geometry:
