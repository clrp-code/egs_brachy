...
#     photon-emitting sources, Medical Physics (sccepted, 2021).
#
#
:start geometry definition:
    ...
    :start geometry:
        ...
        :start media input:
            media = WATER_0.998, WATER_0.998 # SILASTIC, MODULAY
            set medium = 0 0
            set medium = 1 1
        :stop media input:
    :stop geometry:
    ...
    :start geometry:
        ...
        library = egs_planes
        type = EGS_Zplanes
        positions =  -1.505 -1.304808 -1.2755489 -1.011385189
    :stop geometry: 
