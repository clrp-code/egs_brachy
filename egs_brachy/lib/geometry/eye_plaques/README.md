# CLRP egs++ eye plaque models version 2 (CLRP_EPv2) #

CLRP Eye Plaque Database version 2 (CLRP_EPv2) of egs_brachy models for photon-emitting sources



This repository contains geometry model files for 8 COMS, 5 BEBIG, and 4 Representative models for Pd-103, I-125, and Cs-131 seeds described and validated in the CLRP_EPv2 database, plus Iris melanoma plaque models (see `Iris/`).
...
If you use the Iris plaque models under `Iris/`, please also cite:
