...
1. 'normal' (default):  a regular simulation. For an example see [tests/seeds_in_xyz/seeds_in_xyz.egsinp](../tests/seeds_in_xyz/seeds_in_xyz.egsinp).
...
dose superposition type calculations. For an example see [tests/tg43mode/tg43mode.egsinp](../tests/tg43mode/tg43mode.egsinp).
3. 'volume correction only': Just run the volume correction routines, print
the results and then quit. No actual dose calculations will be done. For an example see [tests/volume_correction/vc.egsinp](../tests/volume_correction/vc.egsinp).
...
mode block (see [tests/single_generator/single_generator.egsinp](../tests/single_generator/single_generator.egsinp)).
...
Disabling the single generator (see [tests/single_generator/multiple_generator.egsinp](../tests/single_generator/multiple_generator.egsinp)) mode may be slightly faster for some simulations
...
2. 'phantom geometries': this tells egs_brachy which geometries to score dose
   ...
   are allowed to be used as phantoms:
    1. EGS_XYZGeometry (library egs_ndgeometry, see [tests/seeds_in_xyz/seeds_in_xyz.egsinp](../tests/seeds_in_xyz/seeds_in_xyz.egsinp))
    2. EGS_RZGeometry (library egs_rz, see [tests/stepped_source/stepped.egsinp](../tests/stepped_source/stepped.egsinp))
...
- 'score energy deposition' : (Optional) Controls whether dose from particle
  ...
  'no' (default). See
  [tests/brem_cyl/brem_cyl.egsinp](../tests/brem_cyl/brem_cyl.egsinp) for an
  example
...
- 'score scatter dose' : (Optional) Controls whether scatter dose (normalized
  ...
  [tests/scatter/scatter.egsinp](../tests/scatter/scatter.egsinp) for an example.

- 'spectrum scoring': (Optional) zero or more input blocks specifying spectra
  to score (described below). See
  [tests/spec_absolute/spec_absolute.egsinp](../tests/spec_absolute/spec_absolute.egsinp),
  [tests/spec_eflu/spec_eflu.egsinp](../tests/spec_eflu/spec_eflu.egsinp), and
  [tests/spec_vox/spec_vox.egsinp](../tests/spec_vox/spec_vox.egsinp) for
  examples.
...
- 'phsp scoring': (Optional) zero or one input block specifying whether to
  ...
  [tests/phsp_scoring/phsp_score.egsinp](../tests/phsp_scoring/phsp_score.egsinp)
    for an example.
...
- 'output voxel info files': (Optional) Controls whether voxel info files are
  ...
  [tests/volume_correction/vc.egsinp](../tests/volume_correction/vc.egsinp) for
  an example.
...
The input file
[tests/volume_correction/vc.egsinp](../tests/volume_correction/vc.egsinp)
...
1. Absolute counts of particles escaping the surface of the source (See [tests/spec_absolute/spec_absolute.egsinp](../tests/spec_absolute/spec_absolute.egsinp))
2. Energy weighted spectra of particles on the surface of the source (See [tests/spec_eflu/spec_eflu.egsinp](../tests/spec_eflu/spec_eflu.egsinp))
3. Photon energy fluence in a single geometry region (See [tests/spec_vox/spec_vox.egsinp](../tests/spec_vox/spec_vox.egsinp))
...
[tests/phsp_run/phsp_run.egsinp](../tests/phsp_run/phsp_run.egsinp) for an
...
to be 1.  See
[tests/variable_activity/variable.egsinp](../tests/variable_activity/variable.egsinp)
for an example.
...
[tests/stepped_source/stepped.egsinp](../tests/stepped_source/stepped.egsinp)
...
[tests/phsp_run/phsp_run.egsinp](../tests/phsp_run/phsp_run.egsinp) input file
for an example of this feature.
...
2. `Source ECUT` & `Source PCUT` these two transport parameters allow you to
   ...
   for x-ray source simulations (see e.g.
       [tests/brem_cyl/brem_cyl.egsinp](../tests/brem_cyl/brem_cyl.egsinp)).
...
[tests/phsp_run/phsp_run.egsinp](../tests/phsp_run/phsp_run.egsinp),
[tests/recycling/recycling.egsinp](../tests/recycling/recycling.egsinp),
[tests/tg43mode_recycle/tg43mode_recycling.egsinp](../tests/tg43mode_recycle/tg43mode_recycling.egsinp),
[tests/variable_w_recycling/variable_w_recycling.egsinp](../tests/variable_w_recycling/variable_w_recycling.egsinp).
...
See [tests/brem_cyl/brem_cyl.egsinp](../tests/brem_cyl/brem_cyl.egsinp) for
...
See [tests/volume_correction/vc.egsinp](../tests/volume_correction/vc.egsinp) for
...
files or within [tests/test_geoms](../tests/test_geoms).
...
documentation will also be created and placed at `docs/pdf/egs_brachy_manual.pdf`.
