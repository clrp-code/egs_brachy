...
1. 'normal' (default):  a regular simulation. For an example see [eb_tests/seeds_in_xyz/seeds_in_xyz.egsinp](https://github.com/clrp-code/egs_brachy/blob/main/egs_brachy/eb_tests/seeds_in_xyz/seeds_in_xyz.egsinp).
...
dose superposition type calculations. For an example see [eb_tests/tg43mode/tg43mode.egsinp](https://github.com/clrp-code/egs_brachy/blob/main/egs_brachy/eb_tests/tg43mode/tg43mode.egsinp).
3. 'volume correction only': Just run the volume correction routines, print
the results and then quit. No actual dose calculations will be done, so the number of histories specified in the run control input block (ncase) is ignored. For an example see [eb_tests/volume_correction/vc.egsinp](https://github.com/clrp-code/egs_brachy/blob/main/egs_brachy/eb_tests/volume_correction/vc.egsinp).
...
mode block (see [eb_tests/single_generator/single_generator.egsinp](https://github.com/clrp-code/egs_brachy/blob/main/egs_brachy/eb_tests/single_generator/single_generator.egsinp)).
...
Disabling the single generator (see [eb_tests/single_generator/multiple_generator.egsinp](https://github.com/clrp-code/egs_brachy/blob/main/egs_brachy/eb_tests/single_generator/multiple_generator.egsinp)) mode may be slightly faster for some simulations
...
2. 'phantom geometries': this tells egs_brachy which geometries to score dose
   ...
   are allowed to be used as phantoms:
    1. EGS_XYZGeometry (library egs_ndgeometry, see [eb_tests/seeds_in_xyz/seeds_in_xyz.egsinp](https://github.com/clrp-code/egs_brachy/blob/main/egs_brachy/eb_tests/seeds_in_xyz/seeds_in_xyz.egsinp))
    2. EGS_RZGeometry (library egs_rz, see [eb_tests/stepped_source/stepped.egsinp](https://github.com/clrp-code/egs_brachy/blob/main/egs_brachy/eb_tests/stepped_source/stepped.egsinp))
    3. EGS_cSpheres (library egs_spheres, see [eb_tests/scatter/scatter.egsinp](../eb_tests/scatter/scatter.egsinp))
...
- 'score energy deposition' : (Optional) Controls whether dose from particle
  ...
  'no' (default). See
  [eb_tests/brem_cyl/brem_cyl.egsinp](https://github.com/clrp-code/egs_brachy/blob/main/egs_brachy/eb_tests/brem_cyl/brem_cyl.egsinp) for an
  example
...
- 'score scatter dose' : (Optional) Controls whether scatter dose (normalized
  ...
  See [eb_tests/scatter/scatter.egsinp](https://github.com/clrp-code/egs_brachy/blob/main/egs_brachy/eb_tests/scatter/scatter.egsinp) for an example.

- 'spectrum scoring': (Optional) zero or more input blocks specifying spectra
  to score (described below). See
  [eb_tests/spec_absolute/spec_absolute.egsinp](https://github.com/clrp-code/egs_brachy/blob/main/egs_brachy/eb_tests/spec_absolute/spec_absolute.egsinp),
  [eb_tests/spec_eflu/spec_eflu.egsinp](https://github.com/clrp-code/egs_brachy/blob/main/egs_brachy/eb_tests/spec_eflu/spec_eflu.egsinp), and
  [eb_tests/spec_vox/spec_vox.egsinp](https://github.com/clrp-code/egs_brachy/blob/main/egs_brachy/eb_tests/spec_vox/spec_vox.egsinp) for
  examples.
...
- 'phsp scoring': (Optional) zero or one input block specifying whether to
  ...
  [eb_tests/phsp_scoring/phsp_score.egsinp](https://github.com/clrp-code/egs_brachy/blob/main/egs_brachy/eb_tests/phsp_scoring/phsp_score.egsinp)
    for an example.
...
- 'output voxel info files': (Optional) Controls whether voxel info files are
  ...
  [eb_tests/volume_correction/vc.egsinp](https://github.com/clrp-code/egs_brachy/blob/main/egs_brachy/eb_tests/volume_correction/vc.egsinp) for
  an example.
...
The input file
[eb_tests/volume_correction/vc.egsinp](https://github.com/clrp-code/egs_brachy/blob/main/egs_brachy/eb_tests/volume_correction/vc.egsinp)
...
1. Absolute counts of particles escaping the external surface of the source. For brachytherapy seeds distributed with egs\_brachy, this corresponds to the encapsulation of the source. (See [eb_tests/spec_absolute/spec_absolute.egsinp](https://github.com/clrp-code/egs_brachy/blob/main/egs_brachy/eb_tests/spec_absolute/spec_absolute.egsinp))
2. Energy weighted spectra of particles on the surface of the source (See [eb_tests/spec_eflu/spec_eflu.egsinp](https://github.com/clrp-code/egs_brachy/blob/main/egs_brachy/eb_tests/spec_eflu/spec_eflu.egsinp))
3. Photon energy fluence in a single geometry region (See [eb_tests/spec_vox/spec_vox.egsinp](https://github.com/clrp-code/egs_brachy/blob/main/egs_brachy/eb_tests/spec_vox/spec_vox.egsinp))
...
[eb_tests/phsp_run/phsp_run.egsinp](https://github.com/clrp-code/egs_brachy/blob/main/egs_brachy/eb_tests/phsp_run/phsp_run.egsinp) for an
...
to be 1.  See
[eb_tests/variable_activity/variable.egsinp](https://github.com/clrp-code/egs_brachy/blob/main/egs_brachy/eb_tests/variable_activity/variable.egsinp)
for an example.
...
[eb_tests/stepped_source/stepped.egsinp](https://github.com/clrp-code/egs_brachy/blob/main/egs_brachy/eb_tests/stepped_source/stepped.egsinp)
...
[eb_tests/phsp_run/phsp_run.egsinp](https://github.com/clrp-code/egs_brachy/blob/main/egs_brachy/eb_tests/phsp_run/phsp_run.egsinp) input file
for an example of this feature.
...
2. `Source ECUT` & `Source PCUT` these two transport parameters allow you to
   ...
   for x-ray source simulations (see e.g.
       [eb_tests/brem_cyl/brem_cyl.egsinp](https://github.com/clrp-code/egs_brachy/blob/main/egs_brachy/eb_tests/brem_cyl/brem_cyl.egsinp)).
...
[eb_tests/phsp_run/phsp_run.egsinp](https://github.com/clrp-code/egs_brachy/blob/main/egs_brachy/eb_tests/phsp_run/phsp_run.egsinp),
[eb_tests/recycling/recycling.egsinp](https://github.com/clrp-code/egs_brachy/blob/main/egs_brachy/eb_tests/recycling/recycling.egsinp),
[eb_tests/tg43mode_recycle/tg43mode_recycling.egsinp](https://github.com/clrp-code/egs_brachy/blob/main/egs_brachy/eb_tests/tg43mode_recycle/tg43mode_recycling.egsinp),
[eb_tests/variable_w_recycling/variable_w_recycling.egsinp](https://github.com/clrp-code/egs_brachy/blob/main/egs_brachy/eb_tests/variable_w_recycling/variable_w_recycling.egsinp).
...
See [eb_tests/brem_cyl/brem_cyl.egsinp](https://github.com/clrp-code/egs_brachy/blob/main/egs_brachy/eb_tests/brem_cyl/brem_cyl.egsinp) for
...
files or within [eb_tests/test_geoms](https://github.com/clrp-code/egs_brachy/blob/main/egs_brachy/eb_tests/test_geoms).
...
markdown documents are then compiled to HTML by doxygen.

This document (`egs_brachy.md`) and the scripts for generating the library and
test documents are located in `_docs/`. Source PDFs for the user manual and CLRP
database papers live under `_docs/` and are published from the tracked
`docs/pdf/` directory on GitHub Pages.

**Published site:** HTML is built by GitHub Actions on every push to `main` and
deployed to https://clrp-code.github.io/egs_brachy/ . Generated HTML is not
committed to the repository.

**Local preview:** from the `egs_brachy/` application directory run:

```
make docs
```

That writes a gitignored preview under `_site/` at the repository root (open
`_site/index.html`). Optionally `make docs-pdf` also builds the Doxygen LaTeX
technical manual PDF into `_site/pdf/`.

When you change `_docs/` sources, `lib/` content that feeds the geometry library
pages, or files under `docs/pdf/`, commit those sources only — CI regenerates
HTML on merge to `main`.
